    ...
    >
      {variant === "dots" && (
        <>
          ...
          <div
            className="absolute inset-0 animate-[dotWave_5.3s_ease-in-out_infinite] dark:hidden"
            style={{
              backgroundImage: `radial-gradient(circle at 1px 1px, var(--muted-foreground) 1px, transparent 0)`,
              backgroundSize: "40px 40px",
          ...
          />
          <div
            className="absolute inset-0 hidden animate-[dotWaveDark_5.3s_ease-in-out_infinite] dark:block"
            style={{
              backgroundImage: `radial-gradient(circle at 1px 1px, var(--muted-foreground) 1px, transparent 0)`,
              backgroundSize: "40px 40px",
              maskImage: `linear-gradient(135deg, transparent 0%, transparent 35%, white 50%, transparent 65%, transparent 100%)`,
